...
export const getSidePanelElements = (): SidePanelElements => ({
  ...
  modelSelectorBtn: byId<HTMLButtonElement>('modelSelectorBtn'),
  modelSelectorLabel: byId<HTMLElement>('modelSelectorLabel'),
  modelSelectorDropdown: byId<HTMLElement>('modelSelectorDropdown'),
  modelSelectorSearch: byId<HTMLInputElement>('modelSelectorSearch'),
