...
export const PROVIDER_REGISTRY: Record<string, ProviderDefinition> = {
  ...
  kimi: {
    ...
    models: [
      { id: 'kimi-k2.5', label: 'Kimi K2.5', contextWindow: 256000, supportsVision: true },
      { id: 'kimi-k2-thinking', label: 'Kimi K2 Thinking', contextWindow: 256000 },
      { id: 'kimi-k2-thinking-turbo', label: 'Kimi K2 Thinking Turbo', contextWindow: 256000 },
      { id: 'kimi-k2-turbo-preview', label: 'Kimi K2 Turbo', contextWindow: 256000 },
      { id: 'kimi-k2-0905-preview', label: 'Kimi K2 0905', contextWindow: 256000 },
      { id: 'kimi-k2-0711-preview', label: 'Kimi K2 0711', contextWindow: 128000 },
  ...
  glm: {
    ...
    normalizeBaseUrl: normalizeAnthropicBaseUrl,
    models: [
      { id: 'glm-5.1', label: 'GLM-5.1', contextWindow: 128000 },
      { id: 'glm-5', label: 'GLM-5', contextWindow: 128000 },
      { id: 'glm-5-turbo', label: 'GLM-5 Turbo', contextWindow: 128000 },
      { id: 'glm-4.7', label: 'GLM-4.7', contextWindow: 128000 },
      { id: 'glm-4.6', label: 'GLM-4.6', contextWindow: 128000 },
      { id: 'glm-4.5', label: 'GLM-4.5', contextWindow: 128000 },
      { id: 'glm-4.5-air', label: 'GLM-4.5 Air', contextWindow: 128000 },
    ],
  },
  minimax: {
    key: 'minimax',
    ...
    models: [
      ...
      { id: 'MiniMax-M2.5', label: 'MiniMax M2.5', contextWindow: 1000000 },
    ],
  },
  'qwen-oauth': {
    key: 'qwen-oauth',
